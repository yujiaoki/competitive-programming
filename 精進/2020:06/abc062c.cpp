...
int main(void){
    ...
    if( h % 3 == 0 || w % 3 == 0) {
        ...
        double divided_three = h*w/3;
        double a = 100000;
        int x;
        FOR(i,1,w) {
            if (a > abs(divided_three-i*h)) {
                a = abs(divided_three-i*h);
                x = i;
                area1 = h*i;
            }
        }
        double divided_two = (w-x)*h/2;
        double b = 10000;
        int y;
        FOR(i,1,h) {
            if (b > abs(divided_two-(w-x)*i)) {
                b = abs(divided_two-(w-x)*i);
                y = i;
                area2 = (w-x)*i;
                area3 = (w-x)*(h-i);
            }
